    ...
    <div className="min-h-screen flex flex-col pb-16">
      ...
      <header className="bg-surface-800 border-b border-surface-700 px-4 py-3 flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          <span className="text-surface-400 text-xs hidden sm:block">
            {user?.name}
          </span>
          <button
            onClick={logout}
      ...
      {/* Bottom Tab Bar */}
      <nav className="fixed bottom-0 left-0 right-0 bg-surface-900/80 backdrop-blur-lg border-t border-surface-800 flex z-50 safe-area-bottom">
