                      ...
                      {p.churches && p.churches.length > 0 ? (
                        <div className="flex flex-wrap gap-1.5">
                          {p.churches.map((pc) => (
                            <span
                              key={pc.church_id}
                              className="badge bg-primary-500/10 text-primary-500 border-primary-500/20"
                            >
                        ...
                        <span className="text-surface-500 text-xs font-bold uppercase tracking-widest">
                          Nessuna
                        </span>
                      )}
                    </td>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {p.churches && p.churches.length > 0 ? (
                      p.churches.map((pc) => (
                        <span
                          key={pc.church_id}
                          className="px-2.5 py-1 bg-primary-500/10 text-primary-500 border border-primary-500/20 rounded-lg text-[10px] font-black uppercase tracking-tighter"
                        >
                          {pc.church?.name || `CH#${pc.church_id}`}
                        </span>
                      ))
                    ) : (
                      <span className="text-surface-600 text-[10px] font-bold uppercase tracking-widest italic">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="input"
            placeholder="don.mario@email.com"
            required
          />
        </div>
        <div>
